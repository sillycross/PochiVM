...
struct FICallExprCheckExceptionImpl
{
    ...
    static void f(uintptr_t stackframe, DEF_MEM2REG_PARAMS, OpaqueParams... opaqueParams, uint64_t hasException) noexcept
    {
        // Put the false branch (which is the no-exception case) at end.
        //
        FIConditionalJumpHelper::execute_1_0<FIConditionalJumpHelper::Mode::LikelyMode, MEM2REG_TYPES, OpaqueParams...>(hasException != 0, stackframe, PASS_MEM2REG_PARAMS, opaqueParams...);
    }
