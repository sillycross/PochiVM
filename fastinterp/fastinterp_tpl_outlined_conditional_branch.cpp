...
//
struct FIOutlinedConditionalBranchImpl
{
    ...
    {
        FIConditionalJumpHelper::execute_0_1<false /*putFalseBranchAtEnd*/, OpaqueParams...>(cond, stackframe, opaqueParams...);
    }
...
void __pochivm_build_fast_interp_library__()
{
    ...
    RegisterBoilerplate<FIOutlinedConditionalBranchImpl>();
}
